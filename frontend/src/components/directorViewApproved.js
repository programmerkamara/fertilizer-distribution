...
const DirectorViewApprovedApplications = () => {
  ...
  return (
    <div>
      ...
      <div className="container">
        <Card>
          <Card.Body>
            <Card.Title className="text-center text-success"><b>Approved Fertilizer Applications</b></Card.Title>
            <Form.Control
              type="text"
...
export default DirectorViewApprovedApplications;
